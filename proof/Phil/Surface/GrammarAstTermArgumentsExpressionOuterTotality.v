...
(* Converse for the outer-expression lift through term_arguments from #1277. *)

Lemma
  phase1_surface_normalize_term_argument_expression_outer_values_total_from_suffix_repetition :
  forall path body input rest trees,
    ...
    forall arguments,
      trees = map phase1_surface_term_argument_suffix_tree arguments ->
      exists refined,
...
Proof.
  ...
  - destruct arguments as [|argument arguments]; cbn in Htrees;
    ...
    unfold phase1_surface_term_argument_suffix_tree in Hitem.
    destruct
    ...
    | Hargument : Derives phase1_surface_rules _
        (ENonterminal "expression")
        _ _ (phase1_surface_expression_node_tree argument) |- _ =>
        unfold phase1_surface_expression_node_tree in Hargument;
        destruct
          (phase1_surface_normalize_expression_outer_spine_total_from_derivation
            _ _ _ argument Hargument)
          as [refined_argument [Hrefined_argument Hround_trip]];
...
Lemma
  phase1_surface_normalize_term_argument_expression_outer_values_total_from_entries_derivation :
    ...
    | Hbody : Derives phase1_surface_rules _
        ...
        (PTSequence
          [ phase1_surface_expression_node_tree first;
            PTRepetition
              (map phase1_surface_term_argument_suffix_tree rest_arguments)
          ]) |- _ =>
        destruct
          (derives_sequence_expression_exposes_items
        ...
        | Hfirst : Derives phase1_surface_rules _
            (ENonterminal "expression")
            _ _ (phase1_surface_expression_node_tree first),
          Hrepeat : Derives phase1_surface_rules _
            ...
            _ _
            (PTRepetition
              (map phase1_surface_term_argument_suffix_tree rest_arguments)) |- _ =>
            unfold phase1_surface_expression_node_tree in Hfirst;
            destruct
              (phase1_surface_normalize_expression_outer_spine_total_from_derivation
                _ _ _ first Hfirst)
...
Lemma
  phase1_surface_normalize_term_arguments_expression_outer_spine_total_from_spine_derivation :
  forall arguments path input rest,
    Derives phase1_surface_rules path (ENonterminal "term_arguments")
      input rest (phase1_surface_term_arguments_spine_tree arguments) ->
    exists refined,
      phase1_surface_normalize_term_arguments_expression_outer_spine arguments =
        Some refined.
Proof.
  intros [arguments] path input rest Hderive.
  unfold phase1_surface_term_arguments_spine_tree in Hderive.
  cbn in Hderive.
  destruct
  ...
  | Hentries : Derives phase1_surface_rules _
      ...
      _ _ (phase1_surface_term_argument_entries_tree arguments) |- _ =>
      destruct
        (phase1_surface_normalize_term_argument_expression_outer_values_total_from_entries_derivation
