...
(* Converse for the expression-outer lift into effect_expression from #1280. *)

Lemma
  phase1_surface_normalize_optional_term_arguments_expression_outer_total_from_spine_derivation :
...
Proof.
  ...
  - cbn in Hderive |- *.
    ...
    | Hbody : Derives phase1_surface_rules _
        ...
        (phase1_surface_term_arguments_spine_tree arguments_value) |- _ =>
        destruct
...
Proof.
  ...
  unfold phase1_surface_effect_expression_term_arguments_spine_tree in Hderive.
  cbn in Hderive.
  destruct
  ...
  | Harguments : Derives phase1_surface_rules _
      (EOptional (ENonterminal "term_arguments"))
      _ _ (phase1_surface_optional_term_arguments_spine_tree arguments) |- _ =>
      destruct
        (phase1_surface_normalize_optional_term_arguments_expression_outer_total_from_spine_derivation
