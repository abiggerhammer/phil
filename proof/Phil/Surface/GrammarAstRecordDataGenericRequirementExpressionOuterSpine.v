...
(*
  Lift the expression-outer-refined generic-requirements carrier into the
  ...
  advance from option Phase1SurfaceGenericRequirementsEffectsSpine to
  option Phase1SurfaceGenericRequirementsExpressionOuterSpine.
*)

Record Phase1SurfaceRecordGenericRequirementExpressionOuterSpine : Type := {
  phase1_record_generic_requirement_expression_outer_spine_name : string;
...
Definition phase1_surface_record_generic_requirement_expression_outer_spine_tree
...
Definition
  phase1_surface_normalize_record_generic_requirement_expression_outer_spine
  (record : Phase1SurfaceRecordGenericRequirementEffectsSpine)
  : option Phase1SurfaceRecordGenericRequirementExpressionOuterSpine :=
  match
...
Theorem
  phase1_surface_normalize_record_generic_requirement_expression_outer_spine_round_trip :
  forall record refined,
    phase1_surface_normalize_record_generic_requirement_expression_outer_spine
      record = Some refined ->
    phase1_surface_record_generic_requirement_expression_outer_spine_tree
      refined =
      phase1_surface_record_generic_requirement_effects_spine_tree record.
Proof.
...
Record Phase1SurfaceDataGenericRequirementExpressionOuterSpine : Type := {
  phase1_data_generic_requirement_expression_outer_spine_name : string;
...
Definition phase1_surface_data_generic_requirement_expression_outer_spine_tree
...
Definition
  phase1_surface_normalize_data_generic_requirement_expression_outer_spine
  (data_value : Phase1SurfaceDataGenericRequirementEffectsSpine)
  : option Phase1SurfaceDataGenericRequirementExpressionOuterSpine :=
  match
    phase1_surface_normalize_optional_generic_requirements_expression_outer
...
Theorem
  phase1_surface_normalize_data_generic_requirement_expression_outer_spine_round_trip :
  forall data_value refined,
    phase1_surface_normalize_data_generic_requirement_expression_outer_spine
      data_value = Some refined ->
    phase1_surface_data_generic_requirement_expression_outer_spine_tree
      refined =
      phase1_surface_data_generic_requirement_effects_spine_tree data_value.
Proof.
  intros
...
Definition
  phase1_surface_normalize_data_generic_requirement_expression_outer_tree
  (tree : ParseTree)
  : option Phase1SurfaceDataGenericRequirementExpressionOuterSpine :=
  match
...
Theorem
  ...
  forall tree refined,
    phase1_surface_normalize_data_generic_requirement_expression_outer_tree
      tree = Some refined ->
    phase1_surface_data_generic_requirement_expression_outer_spine_tree refined =
      tree.
Proof.
  intros tree refined Hnormalize.
  unfold
