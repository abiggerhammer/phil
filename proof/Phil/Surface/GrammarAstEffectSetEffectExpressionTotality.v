...
From Phil.Surface Require Import
  ...
  GrammarAstEffectSetTotality
  GrammarAstEffectExpressionTotality.

Import ListNotations.
Open Scope string_scope.

(* Converse for the effect-expression lift through effect sets from #1238. *)

Lemma
  phase1_surface_normalize_effect_expression_values_total_from_suffix_repetition :
  forall path body input rest trees,
    ...
    forall effects,
      trees = map phase1_surface_effect_set_suffix_tree effects ->
      exists refined,
        phase1_surface_normalize_effect_expression_values effects =
          Some refined.
Proof.
  ...
  - destruct effects as [|effect effects]; cbn in Htrees;
    ...
    unfold phase1_surface_effect_set_suffix_tree in Hitem.
    destruct
    ...
    | Heffect : Derives phase1_surface_rules _
        (ENonterminal "effect_expression")
        _ _ (phase1_surface_effect_expression_tree effect) |- _ =>
        unfold phase1_surface_effect_expression_tree in Heffect;
        destruct
          (phase1_surface_normalize_effect_expression_spine_total_from_derivation
            _ _ _ effect Heffect)
          as [refined_effect [Hrefined_effect Hround_trip]];
...
Lemma
  phase1_surface_normalize_effect_expression_values_total_from_entries_derivation :
    ...
    | Hbody : Derives phase1_surface_rules _
        ...
        (PTSequence
          [ phase1_surface_effect_expression_tree first;
            PTRepetition
              (map phase1_surface_effect_set_suffix_tree rest_effects)
          ]) |- _ =>
        destruct
          (derives_sequence_expression_exposes_items
        ...
        | Hfirst : Derives phase1_surface_rules _
            (ENonterminal "effect_expression")
            _ _ (phase1_surface_effect_expression_tree first),
          Hrepeat : Derives phase1_surface_rules _
            ...
            _ _
            (PTRepetition
              (map phase1_surface_effect_set_suffix_tree rest_effects)) |- _ =>
            unfold phase1_surface_effect_expression_tree in Hfirst;
            destruct
              (phase1_surface_normalize_effect_expression_spine_total_from_derivation
                _ _ _ first Hfirst)
              as [refined_first [Hrefined_first Hfirst_round_trip]];
            destruct
...
Lemma
  phase1_surface_normalize_effect_set_effect_expression_literal_spine_total_from_spine_derivation :
  forall literal path input rest,
    Derives phase1_surface_rules path (ENonterminal "effect_set_literal")
      input rest (phase1_surface_effect_set_literal_spine_tree literal) ->
    exists refined,
      phase1_surface_normalize_effect_set_effect_expression_literal_spine
        literal = Some refined.
Proof.
  intros [effects] path input rest Hderive.
  unfold phase1_surface_effect_set_literal_spine_tree in Hderive.
  cbn in Hderive.
  destruct
  ...
  | Hentries : Derives phase1_surface_rules _
      ...
      _ _ (phase1_surface_effect_set_entries_tree effects) |- _ =>
      destruct
        (phase1_surface_normalize_effect_expression_values_total_from_entries_derivation
...
Lemma
  phase1_surface_normalize_effect_set_effect_expression_spine_total_from_spine_derivation :
  forall effects path input rest,
    Derives phase1_surface_rules path (ENonterminal "effect_set_expression")
      input rest (phase1_surface_effect_set_spine_tree effects) ->
    exists refined,
...
Proof.
  ...
  - cbn in Hderive |- *.
    ...
    exists (Phase1EffectSetEffectExpressionLiteral refined_literal).
    rewrite Hrefined_literal.
    reflexivity.
  - exists (Phase1EffectSetEffectExpressionReference reference).
    reflexivity.
Qed.

Theorem
  phase1_surface_normalize_effect_set_effect_expression_tree_total_from_derivation :
...
Proof.
  ...
  destruct
    (phase1_surface_normalize_effect_set_spine_total_from_derivation
