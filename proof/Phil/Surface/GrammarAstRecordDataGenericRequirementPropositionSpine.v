From Phil.Surface Require Import
  ...
  GrammarAstGenericRequirementsPropositionSpine.

(*
  Lift the proposition-refined generic-requirements carrier into the current
  end-of-chain record_decl and data_decl carriers.

  All already-refined declaration fields remain unchanged; only requirements
  advance from option Phase1SurfaceGenericRequirementsTypeSpine to
  option Phase1SurfaceGenericRequirementsPropositionSpine.
*)

Record Phase1SurfaceRecordGenericRequirementPropositionSpine : Type := {
  phase1_record_generic_requirement_proposition_spine_name : string;
  phase1_record_generic_requirement_proposition_spine_generic_params :
    option Phase1SurfaceGenericParamsKindTypeSpine;
  phase1_record_generic_requirement_proposition_spine_mode :
    option Phase1SurfaceStructuralMode;
  phase1_record_generic_requirement_proposition_spine_requirements :
    option Phase1SurfaceGenericRequirementsPropositionSpine;
  phase1_record_generic_requirement_proposition_spine_fields :
    option Phase1SurfaceFieldTypeListSpine
}.

Definition phase1_surface_record_generic_requirement_proposition_spine_tree
  (record : Phase1SurfaceRecordGenericRequirementPropositionSpine) : ParseTree :=
  PTNonterminal "record_decl"
    (PTSequence
      [ PTLiteral "record";
        ...
        phase1_surface_optional_generic_requirements_proposition_tree
          (phase1_record_generic_requirement_proposition_spine_requirements
            record);
        PTLiteral "{";
...
Definition
  phase1_surface_normalize_record_generic_requirement_proposition_spine
  (record : Phase1SurfaceRecordGenericRequirementTypeSpine)
  : option Phase1SurfaceRecordGenericRequirementPropositionSpine :=
  match
  ...
  | Some requirements =>
      Some
        {| phase1_record_generic_requirement_proposition_spine_name :=
...
Theorem
  phase1_surface_normalize_record_generic_requirement_proposition_spine_round_trip :
  forall record refined,
    phase1_surface_normalize_record_generic_requirement_proposition_spine
      record = Some refined ->
    phase1_surface_record_generic_requirement_proposition_spine_tree refined =
      phase1_surface_record_generic_requirement_type_spine_tree record.
Proof.
...
Definition
  phase1_surface_normalize_record_generic_requirement_proposition_tree
  (tree : ParseTree)
  : option Phase1SurfaceRecordGenericRequirementPropositionSpine :=
  match phase1_surface_normalize_record_generic_requirement_type_tree tree with
  | Some record =>
      phase1_surface_normalize_record_generic_requirement_proposition_spine
        record
  | None => None
...
Proof.
  ...
  unfold phase1_surface_normalize_record_generic_requirement_proposition_tree
    in Hnormalize.
  destruct
...
Record Phase1SurfaceDataGenericRequirementPropositionSpine : Type := {
  phase1_data_generic_requirement_proposition_spine_name : string;
  phase1_data_generic_requirement_proposition_spine_generic_params :
    option Phase1SurfaceGenericParamsKindTypeSpine;
  phase1_data_generic_requirement_proposition_spine_mode :
    option Phase1SurfaceStructuralMode;
  phase1_data_generic_requirement_proposition_spine_requirements :
    option Phase1SurfaceGenericRequirementsPropositionSpine;
...
Definition phase1_surface_data_generic_requirement_proposition_spine_tree
...
Definition
  phase1_surface_normalize_data_generic_requirement_proposition_spine
  (data_value : Phase1SurfaceDataGenericRequirementTypeSpine)
  : option Phase1SurfaceDataGenericRequirementPropositionSpine :=
  match
    phase1_surface_normalize_optional_generic_requirements_proposition
  ...
  | Some requirements =>
      Some
        {| phase1_data_generic_requirement_proposition_spine_name :=
...
Theorem
  phase1_surface_normalize_data_generic_requirement_proposition_spine_round_trip :
  forall data_value refined,
    phase1_surface_normalize_data_generic_requirement_proposition_spine
      data_value = Some refined ->
    phase1_surface_data_generic_requirement_proposition_spine_tree refined =
      phase1_surface_data_generic_requirement_type_spine_tree data_value.
Proof.
  intros
...
Definition
  phase1_surface_normalize_data_generic_requirement_proposition_tree
  (tree : ParseTree)
  : option Phase1SurfaceDataGenericRequirementPropositionSpine :=
  match phase1_surface_normalize_data_generic_requirement_type_tree tree with
  | Some data_value =>
      phase1_surface_normalize_data_generic_requirement_proposition_spine
        data_value
  | None => None
...
Proof.
  intros tree refined Hnormalize.
  unfold phase1_surface_normalize_data_generic_requirement_proposition_tree
    in Hnormalize.
  destruct (phase1_surface_normalize_data_generic_requirement_type_tree tree)
