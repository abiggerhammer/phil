...
(* Converse for the generic-requirements proposition lift from #1222. *)

Lemma
  phase1_surface_normalize_generic_requirement_proposition_values_total_from_spine_repetition :
...
Proof.
  ...
  unfold phase1_surface_generic_requirements_type_spine_tree in Hderive.
  cbn in Hderive.
  destruct
      ...
      (PTNonterminal "generic_requirements"
        (PTSequence
          [ PTLiteral "requires";
            PTLiteral "{";
            PTRepetition
              (map phase1_surface_generic_requirement_type_spine_tree entries);
            PTLiteral "}"
          ]))
      Hderive)
  ...
  | Hrepeat : Derives phase1_surface_rules _
      ...
      _ _
      (PTRepetition
        (map phase1_surface_generic_requirement_type_spine_tree entries)) |- _ =>
      destruct
...
Proof.
  ...
  - destruct
    ...
    assert (Hrefined :
      phase1_surface_normalize_generic_requirements_proposition_spine base =
        Some refined).
    {
      unfold phase1_surface_normalize_generic_requirements_proposition_tree
        in Hrefined_tree.
