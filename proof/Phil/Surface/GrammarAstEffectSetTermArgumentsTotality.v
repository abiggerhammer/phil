...
From Phil.Surface Require Import
  ...
  GrammarAstEffectSetEffectExpressionTotality
  GrammarAstEffectExpressionTermArgumentsTotality.

Import ListNotations.
Open Scope string_scope.

(* Converse for the term-arguments lift through effect sets from #1254. *)

Lemma
  phase1_surface_normalize_effect_expression_term_arguments_values_total_from_suffix_repetition :
  forall path body input rest trees,
    ...
    forall effects,
      trees =
        map phase1_surface_effect_expression_refined_suffix_tree effects ->
      exists refined,
...
Proof.
  ...
  - destruct effects as [|effect effects]; cbn in Htrees;
    ...
    unfold phase1_surface_effect_expression_refined_suffix_tree in Hitem.
    destruct
    ...
    | Heffect : Derives phase1_surface_rules _
        (ENonterminal "effect_expression")
        _ _ (phase1_surface_effect_expression_spine_tree effect) |- _ =>
        destruct
          (phase1_surface_normalize_effect_expression_term_arguments_spine_total_from_spine_derivation
...
Lemma
  phase1_surface_normalize_effect_expression_term_arguments_values_total_from_entries_derivation :
    ...
    | Hbody : Derives phase1_surface_rules _
        ...
        (PTSequence
          [ phase1_surface_effect_expression_spine_tree first;
            PTRepetition
              (map
                phase1_surface_effect_expression_refined_suffix_tree
                rest_effects)
          ]) |- _ =>
        destruct
          (derives_sequence_expression_exposes_items
        ...
        | Hfirst : Derives phase1_surface_rules _
            (ENonterminal "effect_expression")
            _ _ (phase1_surface_effect_expression_spine_tree first),
...
Lemma
  phase1_surface_normalize_effect_set_term_arguments_literal_spine_total_from_spine_derivation :
...
Proof.
  intros [effects] path input rest Hderive.
  unfold
    phase1_surface_effect_set_effect_expression_literal_spine_tree in Hderive.
  cbn in Hderive.
  destruct
  ...
  | Hentries : Derives phase1_surface_rules _
      ...
      _ _ (phase1_surface_effect_expression_refined_entries_tree effects)
      |- _ =>
      destruct
        (phase1_surface_normalize_effect_expression_term_arguments_values_total_from_entries_derivation
...
Lemma
  phase1_surface_normalize_effect_set_term_arguments_spine_total_from_spine_derivation :
  forall effects path input rest,
...
Proof.
  ...
  - cbn in Hderive |- *.
    ...
    exists (Phase1EffectSetTermArgumentsLiteral refined_literal).
    rewrite Hrefined_literal.
    reflexivity.
  - exists (Phase1EffectSetTermArgumentsReference reference).
    reflexivity.
Qed.
