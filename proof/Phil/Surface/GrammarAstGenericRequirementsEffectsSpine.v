...
(*
  Lift the effects-refined generic-requirement carrier through
  generic_requirements and its optional wrapper.
*)

Fixpoint phase1_surface_normalize_generic_requirement_effects_values
  (requirements : list Phase1SurfaceGenericRequirementPropositionSpine)
  : option (list Phase1SurfaceGenericRequirementEffectsSpine) :=
  match requirements with
  | [] => Some []
  | requirement :: rest =>
      match
        phase1_surface_normalize_generic_requirement_effects_spine requirement,
        phase1_surface_normalize_generic_requirement_effects_values rest
      with
...
Theorem
  phase1_surface_normalize_generic_requirement_effects_values_round_trip :
  forall requirements refined,
    phase1_surface_normalize_generic_requirement_effects_values requirements =
      Some refined ->
    map phase1_surface_generic_requirement_effects_spine_tree refined =
      map phase1_surface_generic_requirement_proposition_spine_tree requirements.
Proof.
  intros requirements.
...
Record Phase1SurfaceGenericRequirementsEffectsSpine : Type := {
  phase1_generic_requirements_effects_spine_entries :
    list Phase1SurfaceGenericRequirementEffectsSpine
}.

Definition phase1_surface_generic_requirements_effects_spine_tree
  ...
  PTNonterminal "generic_requirements"
    (PTSequence
      [ PTLiteral "requires";
        PTLiteral "{";
        PTRepetition
          (map phase1_surface_generic_requirement_effects_spine_tree
            (phase1_generic_requirements_effects_spine_entries requirements));
        PTLiteral "}"
      ]).

Definition phase1_surface_normalize_generic_requirements_effects_spine
  ...
  match
    phase1_surface_normalize_generic_requirement_effects_values
      (phase1_generic_requirements_proposition_spine_entries requirements)
  with
  | Some entries =>
      Some
        {| phase1_generic_requirements_effects_spine_entries := entries |}
  | None => None
  end.

Theorem
  phase1_surface_normalize_generic_requirements_effects_spine_round_trip :
  forall requirements refined,
...
Proof.
  ...
  cbn in Hnormalize.
  destruct
    (phase1_surface_normalize_generic_requirement_effects_values entries)
...
Definition phase1_surface_optional_generic_requirements_effects_tree
  ...
  | Some value =>
      PTOptionalSome
        (phase1_surface_generic_requirements_effects_spine_tree value)
  end.

Definition phase1_surface_normalize_optional_generic_requirements_effects
  (requirements : option Phase1SurfaceGenericRequirementsPropositionSpine)
  : option (option Phase1SurfaceGenericRequirementsEffectsSpine) :=
  match requirements with
  | None => Some None
  | Some value =>
      match phase1_surface_normalize_generic_requirements_effects_spine value with
...
Theorem
  ...
  forall requirements refined,
    ...
    phase1_surface_optional_generic_requirements_effects_tree refined =
      phase1_surface_optional_generic_requirements_proposition_tree requirements.
Proof.
...
Definition phase1_surface_normalize_generic_requirements_effects_tree
  (tree : ParseTree)
  : option Phase1SurfaceGenericRequirementsEffectsSpine :=
  match phase1_surface_normalize_generic_requirements_proposition_tree tree with
  | Some requirements =>
      phase1_surface_normalize_generic_requirements_effects_spine requirements
  | None => None
  end.
...
Theorem
  ...
  forall tree refined,
    phase1_surface_normalize_generic_requirements_effects_tree tree =
      Some refined ->
    phase1_surface_generic_requirements_effects_spine_tree refined = tree.
Proof.
  intros tree refined Hnormalize.
  unfold phase1_surface_normalize_generic_requirements_effects_tree in Hnormalize.
  destruct
  ...
  transitivity
    (phase1_surface_generic_requirements_proposition_spine_tree requirements).
  - eapply phase1_surface_normalize_generic_requirements_effects_spine_round_trip.
    exact Hnormalize.
  - eapply
...
Definition phase1_surface_normalize_optional_generic_requirements_effects_tree
  (tree : ParseTree)
  : option (option Phase1SurfaceGenericRequirementsEffectsSpine) :=
  match
...
Theorem
  ...
  forall tree refined,
    phase1_surface_normalize_optional_generic_requirements_effects_tree tree =
      Some refined ->
    phase1_surface_optional_generic_requirements_effects_tree refined = tree.
Proof.
  intros tree refined Hnormalize.
  unfold phase1_surface_normalize_optional_generic_requirements_effects_tree
    in Hnormalize.
  destruct
    (phase1_surface_normalize_optional_generic_requirements_proposition_tree tree)
    as [requirements |] eqn:Hrequirements; try discriminate Hnormalize.
