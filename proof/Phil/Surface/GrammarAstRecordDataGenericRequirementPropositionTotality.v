...
From Phil.Surface Require Import
  ...
  GrammarAstRecordDataGenericRequirementTypeTotality
...
(* Converse for the declaration-level proposition refinement from #1227. *)

Lemma
  phase1_surface_normalize_optional_generic_requirements_proposition_total_from_spine_derivation :
...
Proof.
  ...
  - cbn in Hderive |- *.
    ...
    | Hbody : Derives phase1_surface_rules _
        ...
        (phase1_surface_generic_requirements_type_spine_tree requirements) |- _ =>
        destruct
          (phase1_surface_normalize_generic_requirements_proposition_spine_total_from_spine_derivation
...
Theorem
  phase1_surface_normalize_record_generic_requirement_proposition_tree_total_from_derivation :
...
Proof.
  ...
  unfold phase1_surface_record_generic_requirement_type_spine_tree in Hderive.
  destruct
  ...
  | Hrequirements : Derives phase1_surface_rules _
      (EOptional (ENonterminal "generic_requirements"))
      _ _ (phase1_surface_optional_generic_requirements_type_tree requirements)
      |- _ =>
      destruct
        (phase1_surface_normalize_optional_generic_requirements_proposition_total_from_spine_derivation
      ...
      let refined := constr:(
        {| phase1_record_generic_requirement_proposition_spine_name := name;
           phase1_record_generic_requirement_proposition_spine_generic_params :=
             generic_params;
           phase1_record_generic_requirement_proposition_spine_mode := mode;
...
Theorem
  phase1_surface_normalize_data_generic_requirement_proposition_tree_total_from_derivation :
  forall path input rest tree,
...
Proof.
  ...
  cbn in Hbase, Hbase_round_trip.
  rewrite <- Hbase_round_trip in Hderive.
  unfold phase1_surface_data_generic_requirement_type_spine_tree in Hderive.
  destruct
    (derives_nonterminal_exposes_body
  ...
  | Hrequirements : Derives phase1_surface_rules _
      ...
      destruct
        ...
        as [refined_requirements Hrefined_requirements];
      let refined := constr:(
        {| phase1_data_generic_requirement_proposition_spine_name := name;
           phase1_data_generic_requirement_proposition_spine_generic_params :=
             generic_params;
           phase1_data_generic_requirement_proposition_spine_mode := mode;
