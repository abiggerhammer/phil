...
(* Converse for the declaration-level expression-outer refinement from #1299. *)

Lemma
  phase1_surface_normalize_optional_generic_requirements_expression_outer_total_from_spine_derivation :
...
Proof.
  ...
  - cbn in Hderive |- *.
    ...
    | Hbody : Derives phase1_surface_rules _
        ...
        |- _ =>
        destruct
          (phase1_surface_normalize_generic_requirements_expression_outer_spine_total_from_spine_derivation
...
Proof.
  ...
  unfold phase1_surface_record_generic_requirement_effects_spine_tree in Hderive.
  destruct
  ...
  | Hrequirements : Derives phase1_surface_rules _
      ...
      let refined := constr:(
        {| phase1_record_generic_requirement_expression_outer_spine_name := name;
           phase1_record_generic_requirement_expression_outer_spine_generic_params :=
             generic_params;
           phase1_record_generic_requirement_expression_outer_spine_mode := mode;
...
Proof.
  ...
  cbn in Hbase, Hbase_round_trip.
  rewrite <- Hbase_round_trip in Hderive.
  unfold phase1_surface_data_generic_requirement_effects_spine_tree in Hderive.
  destruct
    (derives_nonterminal_exposes_body
  ...
  | Hrequirements : Derives phase1_surface_rules _
      ...
      destruct
        ...
        as [refined_requirements Hrefined_requirements];
      let refined := constr:(
        {| phase1_data_generic_requirement_expression_outer_spine_name := name;
           phase1_data_generic_requirement_expression_outer_spine_generic_params :=
             generic_params;
           phase1_data_generic_requirement_expression_outer_spine_mode := mode;
