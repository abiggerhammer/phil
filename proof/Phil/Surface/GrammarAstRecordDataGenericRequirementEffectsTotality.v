...
From Phil.Surface Require Import
  ...
  GrammarAstGenericRequirementsEffectsTotality
  GrammarAstRecordDataGenericRequirementPropositionTotality
...
(* Converse for the declaration-level effects refinement from #1266. *)

Lemma
  phase1_surface_normalize_optional_generic_requirements_effects_total_from_spine_derivation :
...
Proof.
  ...
  - cbn in Hderive |- *.
    ...
    | Hbody : Derives phase1_surface_rules _
        ...
        (phase1_surface_generic_requirements_proposition_spine_tree
          requirements) |- _ =>
        destruct
...
Proof.
  ...
  unfold
    phase1_surface_record_generic_requirement_proposition_spine_tree in Hderive.
  destruct
  ...
  | Hrequirements : Derives phase1_surface_rules _
      ...
      let refined := constr:(
        {| phase1_record_generic_requirement_effects_spine_name := name;
           phase1_record_generic_requirement_effects_spine_generic_params :=
             generic_params;
           phase1_record_generic_requirement_effects_spine_mode := mode;
...
Proof.
  ...
  rewrite <- Hbase_round_trip in Hderive.
  unfold
    phase1_surface_data_generic_requirement_proposition_spine_tree in Hderive.
  destruct
    (derives_nonterminal_exposes_body
  ...
  | Hrequirements : Derives phase1_surface_rules _
      ...
      destruct
        ...
        as [refined_requirements Hrefined_requirements];
      let refined := constr:(
        {| phase1_data_generic_requirement_effects_spine_name := name;
           phase1_data_generic_requirement_effects_spine_generic_params :=
             generic_params;
           phase1_data_generic_requirement_effects_spine_mode := mode;
