...
(* Converse for the generic-requirements expression-outer lift from #1294. *)

Lemma
  phase1_surface_normalize_generic_requirement_expression_outer_values_total_from_spine_repetition :
  forall path body input rest trees,
    ...
    forall requirements,
      trees =
        map
          phase1_surface_generic_requirement_effects_spine_tree
          requirements ->
      exists refined,
...
Proof.
  ...
  unfold phase1_surface_generic_requirements_effects_spine_tree in Hderive.
  cbn in Hderive.
  destruct
