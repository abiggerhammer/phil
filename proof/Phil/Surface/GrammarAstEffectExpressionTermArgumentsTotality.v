...
(* Converse for the effect-expression term-arguments lift from #1248. *)

Lemma
  phase1_surface_normalize_optional_term_arguments_spine_total_from_spine_derivation :
...
Lemma
  ...
  forall effect path input rest,
    Derives phase1_surface_rules path (ENonterminal "effect_expression")
      input rest (phase1_surface_effect_expression_spine_tree effect) ->
    exists refined,
      phase1_surface_normalize_effect_expression_term_arguments_spine effect =
        Some refined.
Proof.
  intros [reference arguments] path input rest Hderive.
  unfold phase1_surface_effect_expression_spine_tree in Hderive.
  cbn in Hderive.
  destruct
  ...
  | Harguments : Derives phase1_surface_rules _
      (EOptional (ENonterminal "term_arguments"))
      _ _ (phase1_surface_optional_term_arguments_tree arguments) |- _ =>
      destruct
        (phase1_surface_normalize_optional_term_arguments_spine_total_from_spine_derivation
...
Theorem
  phase1_surface_normalize_effect_expression_term_arguments_tree_total_from_derivation :
