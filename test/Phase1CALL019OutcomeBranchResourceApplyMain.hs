...
residue
  :: String
  -> Map.Map Data.Text.Text SurfaceCallableOutcomeResourceExpectation
...
residue label bindings active = SurfaceCallableOutcomeResourceResidueBinding
  ...
  , surfaceOutcomeResourceSourceLabel = Data.Text.pack label
  , surfaceOutcomeResourceState = CallableOutcomeState (Data.Text.pack ("state." <> label))
