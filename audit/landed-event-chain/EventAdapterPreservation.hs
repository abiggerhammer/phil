...
-- All positive values, evidence-use lists, residuals and resolver objects come
-- from Phil. The only binding adapter inserts the genuinely returned type in
-- the explicitly supplied Core context. No support table or proof is forged.
payload, binder :: Name
