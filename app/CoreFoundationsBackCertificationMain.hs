...
import Phil.Assurance.RocqCoreFoundations
...
main = do
  ...
  case args of
    [checkedRoot, outputRoot] ->
      mapM_ (certifyOne checkedRoot outputRoot) coreFoundationCertificationSpecs
    _ -> failWith "usage: phil-certify-core-foundations CHECKED_ROOT OUTPUT_ROOT"
