...
import Phil.Assurance.RocqFocusingFoundations
...
main = do
  args <- getArgs
  case args of
    [checkedRoot, outputRoot] -> mapM_ (certifyOne checkedRoot outputRoot) focusingFoundationCertificationSpecs
    _ -> failWith "usage: phil-certify-focusing-foundations CHECKED_ROOT OUTPUT_ROOT"
