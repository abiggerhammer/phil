    ...
    [ systemsSource, systemsObject
      ...
      , systemsCertificatePath, llvmCertificatePath
        ...
        systemsProof <- certify
          systemsVersionSessionChoiceCertificationSpec systemsSource systemsObject
        llvmProof <- certify
          llvmVersionSessionChoiceBoundaryCertificationSpec llvmSource llvmObject
        writeProofCertificate systemsCertificatePath systemsProof
        writeProofCertificate llvmCertificatePath llvmProof
    _ -> failWith
      "usage: phil-certify-version-session-choice SYS.v SYS.vo LLVM.v LLVM.vo SYS.cert LLVM.cert"
