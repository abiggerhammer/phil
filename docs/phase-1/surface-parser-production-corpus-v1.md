...
This corpus fixes concrete parser expectations for the Grammar-v1 forms introduced or repaired by the type-system reconciliation slice. It is a specification target for SURF-002, not evidence that the current Haskell parser already implements Grammar v1.
...
The first corpus covers all six reconciliation areas independently:
